...
const PROGRAM = {
  ID: process.env.REACT_APP_PROGRAM_ADDRESS as string,
  CODE_HASH: process.env.REACT_APP_CODE_HASH as Hex,
}
...
export { ADDRESS, LOCAL_STORAGE, FORM, USER, ROLES, ACTION, ACTIONS, ACTION_ICONS, PROGRAM };
